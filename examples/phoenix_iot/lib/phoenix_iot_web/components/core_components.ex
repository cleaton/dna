defmodule PhoenixIotWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixIotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixIotWeb.Gettext, "errors", msg, opts)
    end
  end
